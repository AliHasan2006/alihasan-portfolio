  ...
  return (
    <footer className="bottom-0 text-white py-8 px-[12vw] md:px-[7vw] lg:px-[20vw]">
      <div className="container mx-auto text-center">
        {/* Name / Logo */}
              <h2 className="text-xl font-semibold text-white-500 hover:text-[#009EC5]"><a href="#about">Ali Hasan</a></h2>
        ...
        <nav className="flex flex-wrap justify-center space-x-4 sm:space-x-6 mt-4">
          {[
            ...
            <button
              ...
              className="hover:text-[#009EC5] text-sm sm:text-base my-1"
            >
              {item.name}
            </button>
          ))}
        ...
        <div className="flex flex-wrap justify-center space-x-4 mt-6">
          {[
            ...
            <a
              ...
              className="text-xl hover:text-[#009EC5] transition-transform transform hover:scale-110"
            >
              {item.icon}
            </a>
          ))}
